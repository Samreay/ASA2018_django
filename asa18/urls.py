...
urlpatterns = [
    ...
    url(r'^register/abstract_received/$', asa18.views.register_abstract_receive,
        name='register_abstract_receive'),
    ...
    url(r'^(?P<meeting>[\w\-]+)/hpc-helpdesk/$', asa18.views.hpc_helpdesk,
        name='hpc_helpdesk'),

    url(r'^(?P<meeting>[\w\-]+)/presenter-information/$', asa18.views.presenter_information,
        name='presenter_information'),

    # url(r'^confirm_payment/$', asa17.views.confirm_payment,
