...
class Command(BaseCommand):
    ...
    email_body = "Dear %s,\n\n" \
                 ...
                 "now been accepted for a talk. The scheduling of your talk has been " \
                 "released in the conference program " \
                 "%s, and is available at https://asa2018.swin.edu.au/asa2018/program/.\n\n" \
